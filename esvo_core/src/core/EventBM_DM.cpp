 ...
 **/
bool esvo_core::core::EventBM::match_an_event(EventDepth *pEvent,
                                              ...
                                              esvo_core::core::EventMatchPair &emPair)
{
  ...
  const Eigen::Vector2d &x_rect = pEvent->x_rect_;
  ...
  {
    emPair.x_left_raw_ = pEvent->x_raw_;
    emPair.x_left_ = pEvent->x_rect_;
    emPair.x_right_ = Eigen::Vector2d(static_cast<double>(bestMatch(0)), static_cast<double>(bestMatch(1)));
    emPair.t_ = pEvent->t_;
    double disparity;
