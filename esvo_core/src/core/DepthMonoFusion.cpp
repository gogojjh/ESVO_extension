...
namespace esvo_core
{
  namespace core
  {
    DepthMonoFusion::DepthMonoFusion(
    ...
    bool
    DepthMonoFusion::propagate_one_point(DepthPoint &dp_prior,
                                         DepthPoint &dp_prop,
    ...
    int DepthMonoFusion::update(std::vector<DepthPoint> &dp_obs,
                                DepthFrame::Ptr &df,
                                int fusion_radius)
    {
      int numFusion = 0;
    ...
    int DepthMonoFusion::fusion(DepthPoint &dp_prop,
                                DepthMap::Ptr &dm,
                                int fusion_radius)
    {
      int numFusion = 0;
    ...
    bool
    DepthMonoFusion::studentTCompatibleTest(
        double invD1, double invD2,
        double var1, double var2)
    {
    ...
    void
    DepthMonoFusion::naive_propagation(
