#ifndef ESVO_CORE_CONTAINER_CAMERASYSTEM_MONO_H
#define ESVO_CORE_CONTAINER_CAMERASYSTEM_MONO_H
...
namespace esvo_core
{
  namespace container
  {
    ...
    public:
      ...
      PerspectiveCamera::Ptr cam_left_ptr_; // intrinsics
    };
  } // namespace container
} // namespace esvo_core

#endif //ESVO_CORE_CONTAINER_CAMERASYSTEM_MONO_H