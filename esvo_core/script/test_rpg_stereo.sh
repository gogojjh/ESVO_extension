...
echo "Start Testing on rpg_monitor, rpg_bin, rpg_desk, rpg_box ..."
#####################################rpg_monitor
...
python3 /home/jjiao/catkin_ws/src/localization/rpg_trajectory_evaluation/scripts/load_eval_results.py\
    -path /home/jjiao/ESVO_result/rpg_stereo\
    -sequence=rpg_monitor,rpg_bin,rpg_desk,rpg_box -est_type=TS,EM2000,EM3000,EM4000,EM5000,TSEM\
